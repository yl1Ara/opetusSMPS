_dmps_complete()
{
    local commands="start stop restart status health log logs event events system-health temperature temp diagnose-reboot viewer update process ps url shell help"
